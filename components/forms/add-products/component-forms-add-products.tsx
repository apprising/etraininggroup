...
const ComponentsFormsAddProducts = () => {
    return (
        <PanelCodeHighlight
    ...
    <div>
        <label htmlFor="actionName">Product Name:</label>
        ...
        >
            <div className="mb-5">
                <form className="space-y-5">
                    <div>
                        <label htmlFor="actionName">Product Name:</label>
                        <input id="actionName" type="text" placeholder="Product Name" className="form-input" />
                    </div>
                    <div>
                        <label htmlFor="actionEmail">Email:</label>
                        <div className="flex flex-1">
...
export default ComponentsFormsAddProducts;
