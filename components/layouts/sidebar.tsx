...
import ComponentsFormsAddProducts from '../forms/add-products/component-forms-add-products';
                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            ...
                            <span className="align-middle text-1x1 font-semibold dark:text-white-light lg:inline ltr:ml-1.5 rtl:mr-1.5">E-TRAINING GROUP</span>
                        </Link>
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="menu nav-item">
                                <Popup trigger = {
                                <button type="button" className={`${currentMenu === 'users' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('Products')}>
                                    <div className="flex items-center">
                                        
                                        <IconPlusCircle className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3">{t('Add Products')}</span>
                                    </div>
                                </button>} position="right center">

                                    <ComponentsFormsAddProducts/>
                                </Popup>
                            </li>
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'users' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('Videos')}>
                                    <div className="flex items-center">
                                        <IconVideo className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black dark:text-[#506690] dark:group-hover:text-white-dark ltr:pl-3 rtl:pr-3">{t('Add Video')}</span>
                                    </div>
                                </button>
                            </li>
                        </ul>
